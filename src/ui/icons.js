/**
 * 图标。同一套线稿：24 格、1.25 描边、圆头圆角、只吃 currentColor，
 * 颜色与大小由外层决定。不用 emoji —— 各系统画得不一样，尺寸也压不住这套界面。
 * 只收这份说明书用得上的；现有图标能说清的事不加新图标。
 */
...
const S = {
  ...
  // 弧的两个端点决定了两个候选圆心，标志位选中画在框内的那一个（圆心 12,12）——
  // 选错的话多半个圆落在 viewBox 外，画出来只剩贴边一条缝
  rotate: '<path d="M20 12A8 8 0 1 1 18.1 6.9"/><path d="M14.6 6.6 18.1 6.9 18.4 3.4"/>',
